...
public class URLLink extends AppCompatActivity implements LinkDialogBox.DialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                Toast.makeText(URLLink.this, "Delete an item", Toast.LENGTH_SHORT).show();
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            outState.putString(KEY_OF_INSTANCE + i + "2", itemList.get(i).getLinkURL());
        }
    ...
    private void addItem(int position) {
        itemList.add(position, new LinkItemCard("Default Empty Link", ""));
        Toast.makeText(URLLink.this, "Add an item", Toast.LENGTH_SHORT).show();
